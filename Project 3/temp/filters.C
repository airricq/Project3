...
void Shrinker::Execute(){
	...
	for(int r = 0; r < picture.getHeight(); r++){
		for(int c = 0; c < picture.getWidth(); c++){
			outputBuff[3 * (r * picture.getWidth() + c) + 0] = inputBuff[3 * (2 * r * input->getWidth() + 2 * c) + 0];
			outputBuff[3 * (r * picture.getWidth() + c) + 1] = inputBuff[3 * (2 * r * input->getWidth() + 2 * c) + 1];
			outputBuff[3 * (r * picture.getWidth() + c) + 2] = inputBuff[3 * (2 * r * input->getWidth() + 2 * c) + 2];
		}
	}
...
void LRConcat::Execute(){
	...
	for(int r = 0; r < input->getHeight(); r++){
		for(int c = 0; c < input2->getWidth(); c++){
			outputBuff[3 * (r * input2->getWidth() + c + input2->getWidth()) + 0] 
				= rightBuff[3 * (r * input2->getWidth() + c) + 0];
			outputBuff[3 * (r * input2->getWidth() + c + input2->getWidth()) + 1] 
				= rightBuff[3 * (r * input2->getWidth() + c) + 1];
			outputBuff[3 * (r * input->getWidth() + c + input2->getWidth()) + 2] 
				= rightBuff[3 * (r * input2->getWidth() + c) + 2];
		}
	}
